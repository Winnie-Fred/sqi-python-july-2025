...
part_of_body_1 = input("Enter a part of the body: ")
part_of_body_2 = input("Enter another part of the body: ")
plural_noun_z = input("Enter a plural_noun: ")
...
PATIENT: I have a pain in my upper {noun_2} which is giving me a severe {part_of_body_1}.
DENTIST: Let me take a look. Open your {part_of_body_2} wide. Good. Now I am going to tap your {plural_noun_z} with my {noun_3}.
...
DENTIST: No. I am going to {verb_1} your tooth and put it in the temporary {noun_8}.
